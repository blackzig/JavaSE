...
public class EditorTexto extends javax.swing.JFrame {
    ...
    private void JBAbrirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBAbrirActionPerformed
        JFileChooser dialogo = openDialogo();
        ...
        if (resposta == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                limpar();
                showMessageDialog(this, "Erro durante a leitura ou escrita!");
            }
        }
    ...
    public void gravar() {
        try {
            ...
            String conteudo = JTATexto.getText();
            bw.write(conteudo);
            bw.close();
            showMessageDialog(this, "Arquivo salvo.");
        } catch (HeadlessException | IOException e) {
            limpar();
            showMessageDialog(this, "Erro durante a gravação!", "ERRO", 0);
        }
    }

    public JFileChooser openDialogo() {
